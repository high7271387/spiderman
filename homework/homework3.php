...
<body>
    ...
    if(isset($_POST['number01'])){
        $default_val=$POST['number01'];
    }else{
        $default_val="";
    }    
    ?>
    <form action="homework3.php" method="post" name="form1" id="form1">
    <p>尋找質數PHP程式：</p>
    <p><label>請輸入要尋找多少個質數：<br><input type="text" name="number01" value="<?php echo $default_val; ?>" id="number01"></label></p>
